        ...
        <div className="w-full max-w-md mx-auto">
            <div className="bg-white/10 dark:bg-black/20 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-white/10 shadow-2xl p-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-text-light dark:text-text-dark mb-2">Welcome Back</h2>
                    <p className="text-text-light/70 dark:text-text-dark/70">Sign in to access your drive</p>
                </div>
