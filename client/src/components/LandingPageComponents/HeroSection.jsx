...
function HeroSection() {
    return (
            <section className="relative w-full p-16 overflow-hidden bg-bg-light dark:bg-bg-dark">
            ...
            <div className="relative z-10 mx-auto flex flex-col-reverse md:flex-row items-center gap-12">
                ...
                <div className="flex-1 text-center md:text-left">
                    <h1 className="text-4xl md:text-5xl font-extrabold leading-tight text-primary">
                        Mushu Drive <br />
                        <span className="text-text-light/60 dark:text-text-dark/60">Power in Your Pocket</span>
                    </h1>
                    <p className="mt-6 text-lg md:text-xl text-text-light dark:text-text-dark">
